...
**Adaptaciones específicas para Alex:**

1. **Prioridad al Pipeline Tool** — Es su proyecto personal y la forma más rápida de que sienta progreso. Sesiones 4–7 lo entregan completo.
2. **Opportunity Radar como proyecto estrella** — Es lo que la empresa le pidió y lo que le da valor frente a sus jefes. Sesiones 8–13 dedicadas.
3. **Git desde el día 2** — Alex necesita Git porque sus proyectos evolucionan. No se puede saltar.
4. **Seguridad como hilo conductor** — Alex ya tiene consciencia del tema (por su colega). Reforzar en cada sesión, no solo en una.
5. **No scraping** — Usar APIs siempre que sea posible. Alex no necesita esa complejidad.
6. **Gemini CLI como backup económico** — Alex ya se queda sin tokens en Claude. Darle la alternativa.
7. **Testing al final pero no opcional** — Sesión 14 dedicada. Es lo que separa un prototipo de un producto.
8. **Lenguaje PM** — Alex piensa en briefs, requerimientos, carga de trabajo. Usar su vocabulario, no el de un developer.

**Ritmo esperado:**

- Sesiones 1–3: Pueden sentirse lentas. Advertir a Alex que es normal.
- Sesiones 4–7: Aceleración visible. Primer proyecto entregado.
- Sesiones 8–13: El proyecto que importa para la empresa. Máxima intensidad.
- Sesiones 14–15: Consolidación y cierre.

**Riesgo principal:** Que los jefes cambien los requerimientos del Opportunity Radar a mitad de camino. Mitigación: definir MVP rígido en sesión 8 y no aceptar cambios de scope hasta la v2.
